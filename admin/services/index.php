...
<head>
   ...
   <title>Servicii &raquo; Pensiunea canina si felina "Aldo" Lasa-ti prietenul pe maini bune</title>
...
<div id="doc">
  ...
  <div id="bd">
    ...
    if($db->table_exists($table)) {
           ...
           $sql = "SELECT content FROM $table where type = 'services'";
